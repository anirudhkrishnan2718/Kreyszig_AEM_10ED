...
\begin{enumerate}
    ...
    \item Solving the h-ODE,
          \begin{align}
              ...
              %   sympy.Poly(x**3 + 2*x**2 - x - 2).all_roots() = [-2, -1, 1]
              \{\lambda_{i}\} & = \{-2, -1, 1\}                                       \\
    ...
    \item Solving the h-ODE,
          \begin{align}
              ...
              %   sympy.Poly(x**3 + 3*x**2 - 5*x - 39).all_roots() = [3, -3 - 2*I, -3 + 2*I]
              \{\lambda_{i}\} & = \{3, -3 \pm 2i\}                                 \\
    ...
    \item Solving the h-ODE,
          \begin{align}
              ...
              %   sympy.Poly(x**3 - 9*x**2 + 27*x - 27).all_roots() = [3, 3, 3]
              \{\lambda_{i}\} & = \{3, 3, 3\}                                  \\
    ...
    \item Solving the h-ODE,
          \begin{align}
              0               & = y''' - 4y'                                 \\
              0               & = \lambda^{3} - 4\lambda                     \\
              %   sympy.Poly(x**3 - 4*x).all_roots() = [-2, 0, 2]
              \{\lambda_{i}\} & = \{-2, 0, 2\}                               \\
