          ...
          \begin{figure}[H]
              ...
              \begin{tikzpicture}
                  \begin{axis}[
                          ...
                          grid = both,
                          colormap/jet, unbounded coords=jump,
                          cycle list = {[samples of colormap = 6]},
                          Ani]
                      \addplot+[thick, samples = 200] table[x index=0,y index=1,
                              col sep=comma, ]{\anitable};
                      \addlegendentry{$k = 0.0$}
                      \addplot+[thick, samples = 200] table[x index=4,y index=5,
                              col sep=comma, ]{\anitable};
                      \addlegendentry{$k = 0.4$}
                      \addplot+[thick, samples = 200] table[x index=8,y index=9,
                              col sep=comma, ]{\anitable};
                      \addlegendentry{$k = 0.8$}
                      \addplot+[thick, samples = 200] table[x index=12,y index=13,
                              col sep=comma, ]{\anitable};
                      \addlegendentry{$k = 1.2$}
                      \addplot+[thick, samples = 200]
          ...
          \begin{figure}[H]
              ...
              \begin{tikzpicture}
                  \begin{axis}[
                          ...
                          legend style={nodes={scale=0.75}},
                          grid = both,
                          colormap/viridis, unbounded coords=jump,
                          cycle list = {[samples of colormap = 5]},
                          Ani]
                      \addplot+[thick, samples = 200] table[x index=2,y index=3,
                              col sep=comma, ]{\anitable};
                      \addlegendentry{$k = 0.2$}
                      \addplot+[thick, samples = 200] table[x index=6,y index=7,
                              col sep=comma, ]{\anitable};
                      \addlegendentry{$k = 0.6$}
                      \addplot+[thick, samples = 200] table[x index=10,y index=11,
                              col sep=comma, ]{\anitable};
                      \addlegendentry{$k = 1.0$}
                      \addplot+[thick, samples = 200] table[x index=14,y index=15,
                              col sep=comma, ]{\anitable};
