...
\begin{enumerate}
          ...
          \begin{figure}[H]
              ...
              \begin{tikzpicture}
                  \begin{axis}[
                      ...
                      \addplot[GraphSmooth, domain = -5:10,
                          restrict y to domain = -100:100]
                      {-5.2 + 5.2 * e^(x)};
                      \addplot[GraphSmooth, domain = -5:10,
                          restrict y to domain = -100:100, dotted, red]
                      {e^(x)};
    ...
    \item Solving ODE and graphing,
          ...
          \begin{align}
              ...
              h                          & = \int\ p(x)\ \dl x                                    &      & = \int -2\ \dl x \\
                                         & = -2x                                                                            \\
              y                          & = e^{-h}\ \int\ e^{h}r(x)\ \dl x + c                                             \\
                                         & = e^{2x} \left[ \int\ e^{-2x} (-4x)\ \dl x + c \right]                           \\
          ...
          \begin{figure}[H]
              ...
              \begin{tikzpicture}
                  \begin{axis}[
                      ...
                      \addplot[GraphSmooth, domain = -2:10,
                          restrict y to domain = -2:10]
                      {2*x + 1 + e^(2*x)};
                      \addplot[GraphSmooth, domain = -2:10,
                          restrict y to domain = -2:10, dotted, red]
                      {e^(2*x)};
    ...
    \item Solving ODE and graphing,
          ...
          \begin{align}
              y'  + ky                    & = e^{-kx}                                                                           \\
              p(x)                        & = k                                                      & r(x)   & = e^{-kx}       \\
              h                           & = \int\ p(x)\ \dl x                                      &        & = \int k\ \dl x \\
                                          & = kx                                                                                \\
              y                           & = e^{-h}\ \int\ e^{h}r(x)\ \dl x + c                                                \\
                                          & = e^{-kx} \left[ \int\ e^{kx} e^{-kx}\ \dl x + c \right]                            \\
          ...
          \begin{figure}[H]
              ...
              \begin{tikzpicture}
                  \begin{axis}[
                      ...
                      \addplot[GraphSmooth, domain = -4:10,
                          restrict y to domain = -2:6]
                      {e^(-x) * (x + 1)};
                      \addplot[GraphSmooth, domain = -4:10,
                          restrict y to domain = -2:6, dotted, red]
                      {e^(-x)};
    ...
    \item Solving ODE and graphing, using the IC $ y(\pi/4) = 3 $
          ...
          \begin{align}
              ...
              h                            & = \int\ p(x)\ \dl x                                         &      & = \int 2\ \dl x        \\
                                           & = 2x                                                                                        \\
              y                            & = e^{-h}\ \int\ e^{h}r(x)\ \dl x + c                                                        \\
                                           & = e^{-2x} \left[ \int\ e^{2x}\ 4 \cos 2x\ \dl x + c \right]                                 \\
              4\int\ e^{2x} \cos 2x\ \dl x & = \frac{4e^{2x}}{2^{2} + 2^{2}}\ (2\cos 2x + 2 \sin 2x)                                     \\
                                           & = e^{2x}(\cos 2x + \sin 2x)                                                                 \\                                                                 \\
              y                            & = \cos 2x + \sin 2x +  ce^{-2x}                             & c    & = \frac{2}{e^{-\pi/2}}
          \end{align}
          ...
          \begin{figure}[H]
              ...
              \begin{tikzpicture}
                  \begin{axis}[
                      ...
                      \addplot[GraphSmooth, domain = -0.5:12,
                          restrict y to domain = -10:20]
                      {cos(2*x) + sin(2*x) + (2*e^(pi/2)) * e^(-2*x)};
                      \addplot[GraphSmooth, domain = -0.5:12,
                          restrict y to domain = -10:20, dotted, red]
                      {(2*e^(pi/2)) * e^(-2*x)};
    ...
    \item Solving ODE and graphing, using the IC $ y(\pi/4) = 3 $
          ...
          \begin{align}
              xy'  - 2y & = x^{3}e^{x}                                                                                     \\
              p(x)      & = \frac{-2}{x}                                               & r(x) & = x^{2}e^{x}               \\
              h         & = \int\ p(x)\ \dl x                                          &      & = \int \frac{-2}{x}\ \dl x \\
                        & = -2\ln (x)                                                                                      \\
              y         & = e^{-h}\ \int\ e^{h}r(x)\ \dl x + c                                                             \\
                        & = x^{2} \left[ \int\ x^{-2}\ (x^{2}e^{x})\ \dl x + c \right]                                     \\
              y         & = x^{2}e^{x} +  cx^{2}                                       & c    & = 1
          \end{align}
    ...
    \item Solving ODE and graphing, using the IC $ y(0) = 0 $
          ...
          \begin{align}
              ...
              p(x)          & = \tan x                                                                         & r(x) & = e^{-0.01x}\cos x    \\
              h             & = \int\ p(x)\ \dl x                                                              &      & = \int\ \tan x\ \dl x \\
                            & = \ln |\sec x|                                                                                                  \\
              y             & = e^{-h}\ \int\ e^{h}r(x)\ \dl x + c                                                                            \\
                            & = \cos x \left[ \int\ \sec x\ \left( e^{-0.01x}\cos x \right)\ \dl x + c \right]                                \\
              y             & = -100\ \cos x\ e^{-0.01x} + c\ \cos x                                           & c    & = 100                 \\
          ...
          \begin{figure}[H]
              ...
              \begin{tikzpicture}
                  \begin{axis}[
                      ...
                      {100*cos(x)};
                      \node[GraphNode, label={90:{(0, 0)}}] at (axis cs:0, 0) {};
                      %   \addlegendentry{$ y = -100\ \cos x\ \left( e^{-0.01x}  - 1 \right) $};
                      %   \addlegendentry{$y_{\text{transient}} = 100\ \cos x $};
                  \end{axis}
              \end{tikzpicture}
          \end{figure}
    ...
    \item Solving ODE and graphing, using the IC $ y(0) = -2.5 $
          ...
          \begin{align}
              y'  + y\sin x & = e^{\cos x}                                                                                         \\
              p(x)          & = \sin x                                                               & r(x) & = e^{\cos x}         \\
              h             & = \int\ p(x)\ \dl x                                                    &      & = \int \sin x\ \dl x \\
                            & = -\cos x                                                                                            \\
              y             & = e^{-h}\ \int\ e^{h}r(x)\ \dl x + c                                                                 \\
                            & = e^{\cos x} \left[ \int\ e^{-\cos x}\ (e^{\cos x})\ \dl x + c \right]                               \\
              y             & = e^{\cos x} (x + c)                                                   & c    & = \frac{-2.5}{e}
          \end{align}
          ...
          \begin{figure}[H]
              ...
              \begin{tikzpicture}
                  \begin{axis}[
                      ...
                      \addplot[GraphSmooth, domain = -2*pi:8*pi,
                          %   restrict y to domain = -10:100
                      ]
                      {(x - 2.5/e) * e^(cos(x))};
                      \addplot[GraphSmooth, domain = -2*pi:8*pi,
                      ...
                      \addlegendentry{$ y = e^{\cos x} \left( x - \frac{2.5}{e} \right) $};
                      \addlegendentry{$y_{\text{transient}} = - \frac{2.5}{e}\ e^{\cos x} $};
                  \end{axis}
              \end{tikzpicture}
          \end{figure}
              ...
              \begin{tikzpicture}
                  \begin{axis}[
                      ...
                      \addplot[JumpPlot, domain = -2*pi:2*pi,
                          ...
                          dotted, red]
                      {e^(3 * (1 - tan(x)))};
                      \node[GraphNode, label={45:{($ \pi/4 $, 4/3)}}] at (axis cs:pi/4, 4/3) {};
    ...
    \item Solving ODE and graphing, using the IC $ y(0) = -2.5 $
          ...
          \begin{align}
              y'             & = (y - 2)\cot x                                                                            \\
              y' - \cot x\ y & = -2\cot x                                                                                 \\
              p(x)           & = -\cot x                                                   & r(x) & = -2\cot x            \\
              h              & = \int\ p(x)\ \dl x                                         &      & = -\int \cot x\ \dl x \\
                             & = -\ln |\sin x|                                                                            \\
              y              & = e^{-h}\ \int\ e^{h}r(x)\ \dl x + c                                                       \\
                             & = \sin x \left[ \int\ \csc x\ (-2\cot x)\ \dl x + c \right]                                \\
              y              & = 2 + c\sin x                                               & c    & = 1
          \end{align}
          ...
          \begin{figure}[H]
              ...
              \begin{tikzpicture}
                  \begin{axis}[
                      ...
                      \addplot[GraphSmooth, domain = 0:4*pi,
                          %   restrict y to domain = -10:100
                      ]
                      {2 + sin(x)};
                      \addplot[GraphSmooth, domain = 0:4*pi,
                          ...
                          dotted, red]
                      {sin(x)};
                      \node[GraphNode, label={0:{($ \pi/2 $, 3)}}] at (axis cs:pi/2, 3) {};
    ...
    \item Solving ODE and graphing, using the IC $ y(1) = 2 $
          ...
          \begin{align}
              xy'  + 4y & = 8x^{4}                                                                                    \\
              p(x)      & = 4/x                                                    & r(x) & = 8x^{3}                  \\
              h         & = \int\ p(x)\ \dl x                                      &      & = \int \frac{4}{x}\ \dl x \\
                        & = 4\ln x                                                                                    \\
              y         & = e^{-h}\ \int\ e^{h}r(x)\ \dl x + c                                                        \\
                        & = x^{-4} \left[ \int\ x^{4}\ (8x^{3})\ \dl x + c \right]                                    \\
              y         & = cx^{-4} + x^{4}                                        & c    & = 1
          \end{align}
          ...
          \begin{figure}[H]
              ...
              \begin{tikzpicture}
                  \begin{axis}[
                      ...
                      \addplot[JumpPlot, domain = 0:4, samples = 200,
    ...
    \item Solving ODE by separation of variables and graphing
          ...
          \begin{align}
              ...
              \frac{1}{6}\ \ln \left( \frac{1}{6y - 15} \right) & = \frac{2}{3}\ \ln[\cosh (1.5x)] \\
              6y - 15                                           & = b[\cosh (1.5x)]^{-4}           \\
              y                                                 & = 2.5 + c\ [\cosh(1.5x)]^{4}
          \end{align}
          ...
          \begin{figure}[H]
              ...
              \begin{tikzpicture}
                  \begin{axis}[
                      ...
                      \addplot[GraphSmooth, domain = 0:2,
                          %   restrict y to domain = -10:100
                      ]
                      {2.5 + (cosh(1.5*x))^(4)};
                    ...
                    \begin{figure}[H]
                        ...
                        \begin{tikzpicture}
                            \begin{axis}[
                                ...
                                \addplot[GraphSmooth, domain = -3:3, samples = 200,
                                    %   restrict y to domain = -10:100
                                ]
                                {x*sin(1/x)};
                                \node[GraphNode, label={-45:{($ 2/\pi $, $ 2/\pi $)}}] at (axis cs:2/pi, 2/pi) {};
                    ...
                    \begin{figure}[H]
                        ...
                        \begin{tikzpicture}
                            \begin{axis}[
                                ...
                                \addplot[GraphSmooth, domain = 0.001:0.05, samples = 1000,
                                    %   restrict y to domain = -10:100
                                ]
                                {x*sin(1/x)};
                                \addplot[GraphSmooth, domain = -0.05:-0.001, samples = 1000,
                                    %   restrict y to domain = -10:100
                                ]
                                {x*sin(1/x)};
                                \addlegendentry{$ y = x\ \sin(1/x) $};
          ...
          \begin{figure}[H]
              ...
              \begin{tikzpicture}
                  \begin{axis}[
                      ...
                      \addplot[GraphSmooth, domain = -4:6,
                          restrict y to domain = -100:100
                      ]
                      {1/(1 - 4*e^(-x))};
          ...
          \begin{figure}[H]
              ...
              \begin{tikzpicture}
                  \begin{axis}[
                      ...
                      \addplot[GraphSmooth, domain = -1:5,
                          %   restrict y to domain = -100:100
                      ]
                      {0.5 - x + e^(-2*x)};
                      \addplot[GraphSmooth, domain = -1:5,
    ...
    \item Solving ODE by separation and graphing,
          ...
          \begin{align}
              y'                                     & = 3.2y - 10y^{2}                                                                 \\
              \int\ \frac{1}{y(3.2 - 10y)}\ \dl y    & =  \int\ \dl x                                                                   \\
              3.2A - 10Ay + By                       & = 1                                   & A & = \frac{1}{3.2},\ B = \frac{10}{3.2} \\
              \ln \left( \frac{y}{3.2 - 10y} \right) & = 3.2x + b                                                                       \\
              \frac{y}{3.2 - 10y}                    & = ce^{3.2x}                                                                      \\
              y                                      & = \frac{3.2e^{3.2x}}{1 + 10ce^{3.2x}} & c & = 0.32
          \end{align}
          ...
          \begin{figure}[H]
              ...
              \begin{tikzpicture}
                  \begin{axis}[
                      ...
                      {1/(1 + (5/16)*e^(-3.2*x))};
                      \node[GraphNode, label={-45:{(0, 32/42)}}] at (axis cs:0, 32/42) {};
          ...
          \begin{figure}[H]
              ...
              \begin{tikzpicture}
                  \begin{axis}[
                      ...
                      {asin(1-x)};
                      \node[GraphNode, label={-0:{(0, $ \pi/2 $)}}] at (axis cs:0, pi/2) {};
          ...
          \begin{figure}[H]
              ...
              \begin{tikzpicture}
                  \begin{axis}[
                      ...
                      \addplot[GraphSmooth, domain = -5:5, variable = \t,
                          %   restrict y to domain = -100:100
                      ]
                      ({2*e^(t) + e^(-2*t)}, {t});
    ...
    \item Solving ODE by separation and graphing,
          ...
          \begin{align}
              ...
              z' + \frac{x-1}{x}\ z & = xe^{x}                                                                                               \\
              p(x)                  & = 1 - 1/x                                                             & r(x) & = xe^{x}                \\
              h                     & = \int\ p(x)\ \dl x                                                   &      & = \int (1 - 1/x)\ \dl x \\
                                    & = x - \ln x                                                                                            \\
              z                     & = e^{-h}\ \int\ e^{h}\ r(x)\ \dl x + c                                                                 \\
                                    & = xe^{-x} \left[ \int\ \frac{e^{x}}{x}\ \{xe^{x}\}\ \dl x + c \right]                                  \\
              z                     & =  cxe^{-x} + \frac{xe^{x}}{2}                                                                         \\
              y                     & = \sqrt{\frac{xe^{x}}{2} \left( 1 + e^{-2x}\right)}                   & c    & =1
          \end{align}
    ...
    \item
          \begin{enumerate}
                    ...
                    \begin{figure}[H]
                        ...
                        \begin{tikzpicture}
                            \begin{axis}[
                                ...
                                \addplot[GraphSmooth, domain = -1:4,
                                    %   restrict y to domain = -100:100
                                ]
                                {x + (e^(-x) + (x^2 - 2*x + 2))^(-1)};
                                \node[GraphNode, label={0:{(0, 1/3)}}] at (axis cs:0, 1/3) {};
                                \addlegendentry{$ y = x + [(x^{2} - 2x + 2) + e^{-x}]^{-1} $};
                            \end{axis}
                        \end{tikzpicture}
                    \end{figure}
              \item Clairaut equation,
                    ...
                    General solution is $ Y = ax - a^{2} $. A singular solution $ y = x^{2}/4 $ which
          ...
          \begin{figure}[H]
              ...
              \begin{tikzpicture}
                  \begin{axis}[
                      ...
                      \addplot[GraphSmooth, domain = 0:150,
                          %   restrict y to domain = -100:100
                      ]
                      {60 + 240*e^(-0.054*x)};
          ...
          \begin{figure}[H]
              ...
              \begin{tikzpicture}
                  \begin{axis}[
                      ...
                      \addplot[GraphSmooth, domain = -3:40,
                          %   restrict y to domain = -100:100
                      ]
                      {1 + e^(-x) - cos(x) + sin(x)};
                      \addplot[GraphSmooth, domain = -3:40, red, dotted,
                          %   restrict y to domain = -100:100
                      ]
                      {e^(-x)};
                      \addlegendentry{$ y = e^{-x} + 1 - \cos (\lambda x) + \sin(\lambda x) $};
                      \addlegendentry{$ y_{\text{transient}} = e^{-x}$};
                  \end{axis}
              \end{tikzpicture}
          \end{figure}
          ...
          \begin{figure}[H]
              ...
              \begin{tikzpicture}
                  \begin{axis}[
                      ...
                      \addplot[GraphSmooth, domain = 0:7,]
                      {3 + 2*e^(-x)} node[pos = 0.75,above]{$ y_{0} = 5 $};
                      \addplot[GraphSmooth, domain = 0:7, red]
          ...
          \begin{figure}[H]
              ...
              \begin{tikzpicture}
                  \begin{axis}[
                      ...
                      \addplot[GraphSmooth, domain = 0:15,OliveGreen]
                      {(1   + (2/3)*e^(-x))^(-1)} node[pos = 0,below]{$ y_{0} = 0.6 $};
                      \addplot[GraphSmooth, domain = 0:15,]
                      {(1  + 9*e^(-x))^(-1)} node[pos = 0.25,right]{$ y_{0} = 0.1 $};
                      \addplot[GraphSmooth, domain = 0:15,red]
    ...
    \item Water inflow and outflow rate is $ \lambda $, and total volume of
          ...
          \begin{align}
              ...
              y(0)     & = \frac{p}{4} + c = p                              & c     & = \frac{3p}{4}              \\
              y        & = \frac{p}{4} \left( 1 + 3e^{-\lambda x/V} \right)                                       \\
              y(t^{*}) & = \frac{p}{2}                                      & t^{*} & = \frac{\ln 3}{\lambda / V}
          \end{align}
          ...
          \begin{figure}[H]
              ...
              \begin{tikzpicture}
                  ...
                  \begin{axis}[
                      ...
                      {0.8/(1 - 0.6*e^(-0.8*x))};
                      \addplot[GraphSmooth, domain = -1:5, OliveGreen,
                          restrict y to domain = -1:4]
                      {1/(1 - 0.5*e^(-x))};
          ...
          \begin{figure}[H]
              ...
              \begin{tikzpicture}
                  \begin{axis}[
                      ...
                      \addplot[GraphSmooth, domain = 0:3,OliveGreen]
                      {0.8/(1 - 0.6*e^(-0.8*x))} node[pos = 0.5,right]{Phase 1};
                      \addplot[GraphSmooth, domain = 3:6,]
                      {1/(1 + 3.655*e^(-x))} node[pos = 0.5,above]{Phase 2};
                      \addplot[GraphSmooth, domain = 6:9,black]
    ...
    \item Death rate $ B $, Birth rate $ A $, with population $ y $ and time $ x $,
          ...
          \begin{align}
              y'                                          & = Ay^{2} - By               &       & = Ay(y - B/A) \\
              y_{1}                                       & = 0                         & y_{2} & = B/A         \\
              \int \frac{1}{y} - \frac{1}{y - B/A}\ \dl x & = -B\int\ \dl x                                     \\
              \frac{y}{y - B/A}                           & = ce^{-Bx}                                          \\
              y                                           & = \frac{(B/A)}{1 - ce^{Bx}}
          \end{align}
          ...
          \begin{figure}[H]
              ...
              \begin{tikzpicture}
                  \begin{axis}[
                      ...
                      \addplot[GraphSmooth, domain = 0:15,black]
    ...
    \item Air inflow and outflow rate is $ \lambda $, and total volume of
          ...
          \begin{align}
              ...
              \frac{y}{V}     & =  1 - ce^{-\lambda x/V}                 & c     & = 1                            \\
              y(t^{*})        & = 0.9V                                   & t^{*} & = \frac{\ln 0.1}{-\lambda / V}
          \end{align}
