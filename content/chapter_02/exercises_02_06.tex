                    ...
                    \begin{figure}[H]
                        ...
                        \begin{tikzpicture}
                            \begin{axis}[
                                ...
                                \addplot[GraphSmooth,domain=-1:0,thin]{0};
                                \addplot[forget plot,GraphSmooth,domain=0:1, thin]{x^(3)};
                                \addlegendentry{$y_{1}$};
                                \addplot[GraphSmooth,domain=-1:0, red, dashed]{x^(3)};
                                \addplot[forget plot,GraphSmooth,domain=0:1, red, dashed]{0};
                                \addlegendentry{$y_{2}$};
                            \end{axis}
                        \end{tikzpicture}
                    \end{figure}
