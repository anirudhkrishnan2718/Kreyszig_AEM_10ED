...
\begin{enumerate}
          ...
          \begin{figure}[H]
              ...
              \begin{tikzpicture}
                  \begin{axis}[
                      ...
                      \addplot[GraphSmooth,domain=0.01:10,]
                      {(5/6)*sin(3*ln(x))};
    ...
    \item Solving the IVP $ y(1) = 3.6,\ y'(1) = 0.4 $ and graphing,
          \begin{align}
              x^{2}y'' + 3xy' + y & = 0                                                                  \\
              a                   & = 3, \quad b= 1                                                      \\
              (a-1)^{2}-4b        & = 0                           & m_{1}, m_{2} & =  -1                 \\
              y                   & = (c_{1} + c_{2} \ln x)x^{-1}                                        \\
              y(1)                & = c_{1} = 3.6                 & y'(1)        & = c_{2} - c_{1} = 0.4 \\
              c_{2}               & = 4.0
          \end{align}
          \begin{figure}[H]
              \centering
              \begin{tikzpicture}
                  \begin{axis}[
                      ...
                      \addplot[GraphSmooth,domain=0:10,]
                      {x^(-1)*(3.6 + 4*ln(x))};
    ...
    \item Solving the IVP $ y(1) = -\pi,\ y'(1) =  2\pi $ and graphing,
          \begin{align}
              ...
              (a-1)^{2}-4b             & = 0                           & m_{1}, m_{2} & =  2                    \\
              y                        & = [ c_{1} + c_{2}\ln x ]x^{2}                                          \\
              y(1)                     & = c_{1} = -\pi                & y'(1)        & = c_{2} + 2c_{1} = 2\pi \\
              c_{2}                    & = 4\pi
          \end{align}
          \begin{figure}[H]
              \centering
    ...
    \item Solving the IVP $ y(1) = 1,\ y'(1) = 1 $ and graphing,
          \begin{align}
              (x^{2}D^{2} + xD + I)y & = 0                                   & a            & = 1, \quad b= 1 \\
              (a-1)^{2}-4b           & = -4 < 0                              & m_{1}, m_{2} & =  0 \pm i      \\
              y                      & = c_{1}\cos(\ln x) + c_{2}\sin(\ln x)                                  \\
              y(1)                   & = c_{1} = 1                           & y'(1)        & = c_{2} = 1
          \end{align}
          \begin{figure}[H]
              \centering
              \begin{tikzpicture}
                  \begin{axis}[
                      ...
                      \addplot[GraphSmooth,domain=0.01:10000,]
                      {sin(ln(x)) + cos(ln(x))};
          ...
          \begin{figure}[H]
              ...
              \begin{tikzpicture}
                  \begin{axis}[
                      ...
                      \addplot[GraphSmooth,domain=0:1.2,]
                      {x^(1/3)*(1 + (1/3)*ln(x))};
    ...
    \item Solving the IVP $ y(1) = 0.1,\ y'(1) = -4.5 $ and graphing,
          \begin{align}
              (x^{2}D^{2}  - xD - 15I)y & = 0                        & a            & = -1, \quad b= -15        \\
              (a-1)^{2}-4b              & = 64 > 0                   & m_{1}, m_{2} & =  -3, 5                  \\
              y                         & = c_{1}x^{-3} + c_{2}x^{5}                                            \\
              y(1)                      & = c_{1} + c_{2} = 0.1      & y'(1)        & = -3c_{1} + 5c_{2} = -4.5 \\
              c_{2}                     & = -0.525                   & c_{1}        & = 0.625
          \end{align}
          \begin{figure}[H]
              \centering
              \begin{tikzpicture}
